...
class AuthUtil {
     ...
     */
    createHmacString(string = '', secretKey = this.defaultSecret, outputType = this.defaultOutputType, algorithm = this.defaultAlgorithm) {
     ...
     * @returns {string}
     */
    createRandomSalt(string = new Date().valueOf().toString(), secretKey = this.defaultSecret, outputType = this.defaultOutputType, algorithm = this.defaultAlgorithm) {
        return this.createHmacString(string, secretKey, outputType, algorithm);
    };
